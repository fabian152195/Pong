...
ImgApptitle = PhotoImage(file="PONG.gif")
img_reducida = ImgApptitle.subsample(2,2)
contenedor_Main.create_image(170, -20, anchor=NW, image=img_reducida)

ImgApp2 = PhotoImage(file="iconPvsP.gif")
img_reducidaApp2 = ImgApp2.subsample(3, 3)

ImgApp3 = PhotoImage(file="iconPvsC.gif")
img_reducidaApp3 = ImgApp3.subsample(3, 3)
...
buttonA.place(x=70, y=200)
buttonB = Button(root, image=img_reducidaApp3, command= lambda: menuPads(2), text="Player vs Computer")
buttonB.place(x=385, y=200)
